          ...
          <div className={styles.info}>
            ...
            <div className={styles.contacts}>
              <div className={styles.contactItem}>
                ...
                <span>
                  <a href={toTelHref(t.phone)} onClick={() => trackPhoneClick("lead_form")}>{t.phone}</a>
                  {t.phone2 && (
                    <>
                      {", "}
                      <a href={toTelHref(t.phone2)} onClick={() => trackPhoneClick("lead_form")}>{t.phone2}</a>
                    </>
                  )}
                  {t.phone3 && (
                    <>
                      {", "}
                      <a href={toTelHref(t.phone3)} onClick={() => trackPhoneClick("lead_form")}>{t.phone3}</a>
                    </>
                  )}
                </span>
              </div>
